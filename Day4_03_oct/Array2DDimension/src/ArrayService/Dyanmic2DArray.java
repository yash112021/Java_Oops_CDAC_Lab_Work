...
public class Dyanmic2DArray {
	...
	public static void main(String[] args) {
		...
		do {
			...
			switch(choice) {
			case 1:
				ArrayService.maxArray(arr);
				break;
			case 2:
				int [] abc=ArrayService.maxRowwise(arr);
			...
			case 3:
				...
				int [] ab=ArrayService.maxColwise(arr);
				for(int x:ab) {
					System.out.print(x+"\t");
				}
				break;
	...
	public static void acceptElements(int [][] arr) {
		...
		for(int i=0;i<arr.length;i++) {
			...
			System.out.println("Enter the "+col+" elements now");
